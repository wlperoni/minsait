...
#define panic_buttion 5 // panic button pin
...
void IRAM_ATTR panic_ISR()
{
// interruption to panic button to have high priority to send data to plataform
   emergency();
}
...
void setup() {
    ...
    pinMode(panic_buttion, INPUT);
    attachInterrupt(panic_buttion, panic_ISR, RISING);
